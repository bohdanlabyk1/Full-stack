...
__decorate([
    (0, typeorm_1.ManyToOne)(() => model_entity_1.User, (user) => user.carts),
    (0, typeorm_1.JoinColumn)({ name: 'userId' }),
    __metadata("design:type", model_entity_1.User)
], Cart.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => products_entity_1.Product, (product) => product.carts),
